...
4 추정을 멈춰야 할 때는 그라운드 카드를 타격합니다.<br/>
핸드 카드의 숫자로 의지의 강약을 표현합니다.
...
앵커링 효과(anchoring effect)는 앞사람의 행동이 뒷사람에게 영향을 주는 걸 말합니다.<br/>
...
#### 차례대로 카드를 제시하는 방법
앵커링 효과(anchoring effect)를 역이용하는 방법입니다.<br/>
앵커링 효과(anchoring effect)로 앞사람의 의견을 적극적으로 청취하고 보완하거나 강화하면서 이견을 좁힙니다.
플래닝 화투를 할 때는 앵커링 효과(anchoring effect)를 역이용하기 위해 시계 반대 방향으로 순서대로 카드를 제시합니다.

<figure>
<img alt="카드 제시하기" src="{{ site.baseurl }}/assets/images/user-guide/플래닝_화투로_작업량(포인트)_산정하기_7.png">
<figcaption>앵커링 효과(anchoring effect)를 역이용하기 위해 차례대로 1장의 카드로 추정하기</figcaption>
</figure>
...
<figcaption>앵커링 효과(anchoring effect)를 역이용하며 여러 장의 카드로 정밀하게 추정하기</figcaption>
</figure>
...
<figcaption>페어 프로그래밍에서 목표 시간 추정하기</figcaption>
</figure>
