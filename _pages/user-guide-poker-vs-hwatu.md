...
우리 팀과, 나와 맞지 않다고 도구의 역할과 효과를 부정하고 외면하기보다는 약간의 응용으로 현지화된 사용은 충분히 가능하지 않을까라는 게 '플래닝 포커' 설계의 기본 가설입니다.

여러분의 현장에서 '플래닝 화투'가 어떻게 활용되는지, 어떤 부분에서 좋았고, 어떤 부분에서 아쉬웠는지 경험을 나눠주시면 더 나은 도구 설계에 도움이 됩니다. 

플래닝 화투에 대한 문의나 의견이 있으시면 아래로 연락 주십시오. 
여러분의 프로젝트가 성공하길 기원합니다.
