...
| 수열 | 피보나치수열 | 2의 거듭제곱 |
| 사용자 | 최대 4명 | 최대 9명 |
| 핸드 카드 | 12장 (0, 2, 3, 5, 8, 13, 20, 40, 100, ∞, ?, ☕) | 5장 (1/2, 1, 2, 4, 8) |
| 핸드 카드 (옵션) | 5장 (XS, S, M, L, XL) | 없음 |
| 그라운드 카드 | 없음 | 9장 (0, ?, ∞, *, XS, S, M, L, XL) |
...
| 카드 | 의미 | 
| - | - |
| 0 | 작업할 필요가 없어 추정이 무의미할 때 |
| ? | 작업 내용이 불명확해서 추정이 불가능할 때 |
| ∞ | 작업량이 너무 커서 추정이 불가능할 때 |
| * | 추정을 멈추고 휴식이 필요할 때 |
...
| * | 1 | 쉬었다가 하시죠. |
| * | ... | ... |
| * | 1/2, 1, 2, 4, 8 | 커피는 내가 쏠테니까 제발 쉬자고!  |
